...
import com.waytechs.model.ejb.facades.AdSectorFacade;
import com.waytechs.model.ejb.facades.GlCompanyFacade;
import com.waytechs.model.entities.AdRole;
import com.waytechs.model.entities.AdSector;
import com.waytechs.model.entities.GlCompany;

@ManagedBean
@ApplicationScoped
public class AdSectorConverter implements Converter, Serializable {
...
//        return (string.trim().equals("") || string == null) ? null : objRes;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        return (o == null || o.equals("")) ? "" : ((AdSector) o).getId() + "";
