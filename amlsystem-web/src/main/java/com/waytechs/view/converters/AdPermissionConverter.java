...
@ManagedBean
@ApplicationScoped
public class AdPermissionConverter implements Converter, Serializable {
...
//        return (string.trim().equals("") || string == null) ? null : objRes;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        return (o == null || o.equals("")) ? "" : ((AdPermission) o).getId() + "";
